...
ASFLAGS="-f elf64"
OBJS="boot/boot.o boot/gdt_flush.o boot/idt_flush.o boot/isr.o kernel/vga.o kernel/gdt.o kernel/idt.o kernel/keyboard.o kernel/shell.o kernel/kernel.o"
...
if [ "$OS" = "Windows_NT" ]; then
    CF="--target=x86_64-elf -ffreestanding -fno-pic -mno-red-zone -mcmodel=kernel -O2 -Iinclude"
    ...
    CF="-ffreestanding -fno-pic -mno-red-zone -mcmodel=kernel -O2 -Iinclude"
